 ...
 $(document).ready(function(){
	  $.getJSON(contextPath+"/propertyDeveloper/loadProfile.htm",
			    function(response, textStatus, jqXHR){
		  			...
		  			$("#welocomeName").html(propertyDeveloper.firstName + " " + propertyDeveloper.lastName);
		 			$("#name").html(propertyDeveloper.firstName + " " + propertyDeveloper.lastName);
		 			$("#primaryPhoneNumber").html(propertyDeveloper.primaryPhoneNumber);
		 			$("#primaryEmailId").html(propertyDeveloper.primaryEmailId);
		 			$("#secondaryPhoneNumber").html(propertyDeveloper.secondaryPhoneNumber);
		 			$("#secondaryEmailId").html(propertyDeveloper.secondaryEmailId);

...
<header>
  <div class="container"> 
    <div class="row">
      <div class="span4">
        <div class="logo"> <a href="http://54.191.172.136:82/thenovoidsman/"><img src="http://54.191.172.136:82/thenovoidsman/wp-content/uploads/2014/12/logo.png" alt="TheNoVoidsMan"/></a></div></div>
      <div class="span8">
        <section class="login-sec">
          <div class="user-bt ano-r"><a href="javascript:void(0);">Register</a>
            <div class="login-drop">
              <ul>
                <li><a href="http://54.191.172.136:8484/PerpetualRents/register/registerLandlordFrame.htm">Landlord</a></li>
                <li><a href="http://54.191.172.136:82/thenovoidsman/contractor-terms-and-conditions/">Contractor</a></li>
                <li><a href="http://54.191.172.136:82/thenovoidsman/charity-tc/">Charity</a></li>
                <li><a href="http://54.191.172.136:8484/PerpetualRents/register/registerPropertyDeveloperFrame.htm">Property Developer</a></li>
              </ul>
            </div>
          </div>
          <div class="user-bt"><a href="javascript:void(0);" data-featherlight="#fl1">Login</a></div>
        </section>
        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
				<ul id="menu-header_menu" class="nav"><li id="menu-item-62" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-62"><a href="http://54.191.172.136:82/thenovoidsman/">Home</a></li>
<li id="menu-item-63" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-63"><a href="http://54.191.172.136:82/thenovoidsman/about-us/">About Us</a></li>
<li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="http://54.191.172.136:82/thenovoidsman/testimonials/">Testimonials</a></li>
<li id="menu-item-138" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-138"><a href="http://54.191.172.136:82/PerpetualRents/register/contactUsFrame.htm">Contact Us</a></li>
</ul>            </div>
          </div>
        </div>
      </div>
...
<section class="banner">
  <div class="flexslider">
    <ul class="slides">
          <li><img src="http://54.191.172.136:82/thenovoidsman/wp-content/uploads/2014/11/slide1.png" title="" alt=""> </li>
            <li><img src="http://54.191.172.136:82/thenovoidsman/wp-content/uploads/2014/11/slide2.png" title="" alt=""> </li>
            <li><img src="http://54.191.172.136:82/thenovoidsman/wp-content/uploads/2014/11/slide3.png" title="" alt=""> </li>
          </ul>
  </div>
  <div class="container">
    <div class="row">
      <div class="span12">
        <div class="call">
                  <div class="ban-cotent">"THE NO VOIDS MAN",<span> if you want to avoid voids then don't avoid me</span></div>
          <div class="ban-cot">Call&nbsp;Now.&nbsp; 07801892817</div>
                  </div>
      </div>
    </div>
  </div>

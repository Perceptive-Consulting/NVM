               ...
               <c:when  test="${property != null}">
                	<c:set var="attachedDrawings" value="${property.getDrawings()}"></c:set>
                		<c:forEach var="drawingObj" items="${attachedDrawings}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${drawingObj.getFileId()}" target="_blank">${drawingObj.getFileName()} <span class="downloadimg"></span></a></div>
                         </c:forEach>
            </c:when>
               ...
               <c:if test="${property != null}">
                	<c:set var="attachedSpecifications" value="${property.getSpecifications()}"></c:set>
                		<c:forEach var="specificationsObj" items="${attachedSpecifications}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${specificationsObj.getFileId()}" target="_blank">${specificationsObj.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
                   </c:if>
               </td>
        </tr>
              ...
              <c:when test="${property != null}">
                	<c:set var="attachedRegistery" value="${property.getLandRegistery()}"></c:set>
                		<c:forEach var="registeryObj" items="${attachedRegistery}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${registeryObj.getFileId()}" target="_blank">${registeryObj.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
                 </c:when>
             <c:when test="${property.getDrawings() == null }">
            <h2>No File Attached</h2> 
          ...
          <td>  <c:if test="${property != null}">
                	<c:set var="attachedTenderDocuments" value="${property.getTenderDocuments()}"></c:set>
                		<c:forEach var="tenderDocumentObj" items="${attachedTenderDocuments}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${tenderDocumentObj.getFileId()}" target="_blank">${tenderDocumentObj.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
             </c:if>
        </td>
        </tr>
          ...
          <c:if test="${property != null}">
                	<c:set var="constructionScheduleDocuments" value="${property.getConstructionSchedule()}"></c:set>
                		<c:forEach var="constructionScheduleObj" items="${constructionScheduleDocuments}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${constructionScheduleObj.getFileId()}" target="_blank">${constructionScheduleObj.getFileName()}<span class="downloadimg"></span></a></div>
                	</c:forEach>
           </c:if>
        </td>
        </tr>
            ...
            <c:if test="${property != null}">
                	<c:set var="additionalDocuments1" value="${property.getAdditionalDocuments1()}"></c:set>
                		<c:forEach var="additionalDoc1" items="${additionalDocuments1}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${additionalDoc1.getFileId()}" target="_blank">${additionalDoc1.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
                </c:if>
       </td>
        </tr>
		 ...
		 <c:if test="${property != null}">
                	<c:set var="additionalDocuments2" value="${property.getAdditionalDocuments2()}"></c:set>
                		<c:forEach var="additionalDoc2" items="${additionalDocuments2}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${additionalDoc2.getFileId()}" target="_blank">${additionalDoc2.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
           </c:if>
           </td>       
        </tr>
       ...
       <c:if test="${property != null}">
                	<c:set var="additionalDocuments3" value="${property.getAdditionalDocuments3()}"></c:set>
                		<c:forEach var="additionalDoc3" items="${additionalDocuments3}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${additionalDoc3.getFileId()}" target="_blank">${additionalDoc3.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
                </c:if>
       </td>
        </tr>
        ...
        <c:if test="${property != null}">
                	<c:set var="additionalDocuments4" value="${property.getAdditionalDocuments4()}"></c:set>
                		<c:forEach var="additionalDoc4" items="${additionalDocuments4}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${additionalDoc4.getFileId()}" target="_blank">${additionalDoc4.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
                </c:if>
       </td>
        </tr>
            ...
            <c:if test="${property != null}">
                	<c:set var="additionalDocuments5" value="${property.getAdditionalDocuments5()}"></c:set>
                		<c:forEach var="additionalDoc5" items="${additionalDocuments5}" >
                			<div class="AttachDoc"><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${additionalDoc5.getFileId()}" target="_blank">${additionalDoc5.getFileName()}<span class="downloadimg"></span></a></div>
                		</c:forEach>
             </c:if>
       </td>
        </tr>
                	...
                	<c:set var="imagesList" value="${property.getImages()}"></c:set>
                		<c:forEach var="image" items="${imagesList}" >
                			<div class="ProjectImg">
                		 	...
                		 	<div><a href="${contextPath}/download/uploadedDocuments.htm?fileId=${constructionScheduleObj.getFileId()}" target="_blank">${constructionScheduleObj.getFileName()}</a></div> 
                		</c:forEach>
                </c:if>

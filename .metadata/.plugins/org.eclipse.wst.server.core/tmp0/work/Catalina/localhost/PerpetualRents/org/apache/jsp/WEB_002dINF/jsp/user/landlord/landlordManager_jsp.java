 ...
 * Generated at: 2015-07-15 11:32:44 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsp.user.landlord;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class landlordManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/jsp/user/landlord/landlordDetail.jsp", Long.valueOf(1436246878620L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write(" <script type=\"text/javascript\">\n");
      out.write(" $(document).ready(function(){\n");
      out.write("\t  $.getJSON(contextPath+\"/landlord/loadProfile.htm\",\n");
      out.write("\t\t\t    function(response, textStatus, jqXHR)\n");
      out.write("\t\t\t    {\n");
      out.write("\t\t  \t\t\tvar landlord = response.data.landlord;\n");
      out.write("\t\t  \t\t\tvar address = response.data.address;\n");
      out.write("\t\t  \t\t\tvar login = response.data.login;\n");
      out.write("\t\t  \t\t\t\n");
      out.write("\t\t  \t\t\t$(\"#welocomeName\").html(landlord.firstName + \" \" + landlord.lastName);\n");
      out.write("\t\t \t\t\t$(\"#name\").html(landlord.firstName + \" \" + landlord.lastName);\n");
      out.write("\t\t \t\t\t$(\"#primaryPhoneNumber\").html(landlord.primaryPhoneNumber);\n");
      out.write("\t\t \t\t\t$(\"#primaryEmailId\").html(landlord.primaryEmailId);\n");
      out.write("\t\t \t\t\t$(\"#secondaryPhoneNumber\").html(landlord.secondaryPhoneNumber);\n");
      out.write("\t\t \t\t\t$(\"#secondaryEmailId\").html(landlord.secondaryEmailId);\n");
  ...
  private boolean _jspx_meth_c_005fimport_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/user/landlord/landlordManager.jsp(74,1) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

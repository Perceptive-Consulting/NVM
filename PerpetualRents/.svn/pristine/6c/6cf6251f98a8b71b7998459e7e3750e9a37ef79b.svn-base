<script src="<%=request.getContextPath()%>/resource/perpetual/admin/pmc/pmcDetails.js"></script> 
 ...
 <div class="container-ar">
  <section class="contant-area">
    <div class="button"><button id="allPMCSId">Back</button><span>&nbsp;&nbsp;&nbsp;</span><button id="enableId">Enable</button>
    ...
    <div class="rgpinnew">
          <ul>
            ...
            <li>
            	<strong>Cities Covered</strong><samp>:</samp><span id="citiesCovered"></span><span style="display: none;" id="pmcCitiesCoveredIdStr"></span>
	            <h4><input type="button" id="editPMCCity" name="edit" value="Edit" class="edit" style="height: 20px;" /> </h4>
	           	<div id="editPMCCityDiv" class="edit-prof" style="display: none;">
	           		<select data-placeholder="Choose Cities..." name="pmcCity" class="chosen-select-pmc-city" multiple style="width:auto;" tabindex="4" id="pmcCityId"></select>
					<label id="cityLabel" style="color:red; display: none;margin-top: 3%">Please Select Cities.</label>
					<div>
						<input id="pmcCityUpdateBtn" type="button" value="Update" class="btn-class" />
						<input id="pmcCityCancelBtn" type="button" value="Cancel" class="btn-class" />
					</div>
	           	</div>
            </li>
            ...
            <li><strong>PhoneNumber</strong><samp>:</samp><span id="phoneNumber"></span></li>
            <li><strong>Address Line1</strong><samp>:</samp><span id="addressLine1"></span></li>
            <li><strong>AddressLine2</strong><samp>:</samp><span id="addressLine2"></span></li>

		  ...
		  $.getJSON(contextPath+"/landlord/loadProfile.htm",
				    function(response, textStatus, jqXHR)  {
				      ...
				      var address = response.data.address;
			 			...
			 			$("#firstName").val(landlord.firstName);
			 			$("#lastName").val(landlord.lastName);
			 			$("#primaryEmailId").val(landlord.primaryEmailId);
			 			$("#secondaryEmailId").val(landlord.secondaryEmailId);
			 			$("#primaryPhoneNumber").val(landlord.primaryPhoneNumber);
			 			$("#secondaryPhoneNumber").val(landlord.secondaryPhoneNumber);
...
<div class="row">
      <div class="span10">
        ...
        <div class="rg-p">
          <form  name="fUpdateLandlord" id="fUpdateLandlord">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="regis">
              ...
              <tr>
                <td style="height: 80px;"><input type="button" id="landlordUpdate" style="margin:30px 188px 0 0;" value="Update" /></td>
              </tr>
            </table>
          </form>
        </div>

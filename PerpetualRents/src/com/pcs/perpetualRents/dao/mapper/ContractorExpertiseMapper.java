...
public class ContractorExpertiseMapper implements RowMapper<Contractor>{
	...
	public Contractor mapRow(ResultSet rst, int arg1) throws SQLException {
		...
		try{
			...
			Expertise expObj = new Expertise();
				expObj.setFunctionalityId(rst.getShort(Expertise.FUNCTIONALITY_ID));
				expObj.setQualification(rst.getString(Expertise.QUALIFICATION));
			obj.setExpertiseObj(expObj);

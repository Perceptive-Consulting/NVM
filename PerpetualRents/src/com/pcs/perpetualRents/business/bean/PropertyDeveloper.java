...
public class PropertyDeveloper extends BusinessObject implements Serializable {

	
	private static final long serialVersionUID = 1L;
	public static final String TABLE_NAME = "tbl_" + ApplicationSettings.APP_NAME + "_" + PropertyDeveloper.class.getSimpleName().toLowerCase();
	...
	public String toString() {
		return "PropertyDeveloper [uniqueReference=" + uniqueReference + ", firstName="
	...
	public JSONObject toJSON(boolean includeParent) throws JSONException{
		...
		jObj.put(PropertyDeveloper.FIRST_NAME, this.firstName);
		jObj.put(PropertyDeveloper.LAST_NAME, this.lastName);
		jObj.put(PropertyDeveloper.PRIMARY_EMAIL_ID, this.primaryEmailId);
		jObj.put(PropertyDeveloper.SECONDARY_EMAIL_ID, this.secondaryEmailId == null ? " " : this.secondaryEmailId);
		jObj.put(PropertyDeveloper.PRIMARY_PHONE_NUMBER, this.primaryPhoneNumber);
		jObj.put(PropertyDeveloper.SECONDARY_PHONE_NUMBER, this.secondaryPhoneNumber == null ? " " : this.secondaryPhoneNumber);
		jObj.put(PropertyDeveloper.UNIQUE_REFERENCE, this.uniqueReference);
		jObj.put(PropertyDeveloper.CREATED_BY, this.getCreatedBy() == null ? "Self Registered" : this.getCreatedBy());
		jObj.put(PropertyDeveloper.CREATED_ON, this.getCreatedOn());
		jObj.put(PropertyDeveloper.MODIFIED_BY, this.getModifiedBy() == null ? "Not yet Modified" : this.getModifiedBy());
		jObj.put(PropertyDeveloper.MODIFIED_ON, this.getModifiedOn() == null ? "Not yet Modified" : this.getModifiedOn());
		jObj.put("completeName", this.firstName + " " + this.lastName);
		jObj.put(PropertyDeveloper.PROPERTY_COUNT, this.propertyCount == null ? 0 : this.propertyCount);
		return jObj;
	}

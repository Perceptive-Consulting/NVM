...
(function($){
	$.fn.SumoSelect=function(options){
		...
		var ret=this.each(function(){
			var selObj=this;if(this.sumo||!$(this).is("select")){
				return
			}
			this.sumo={
					E:$(selObj),is_multi:$(selObj).attr("multiple"),
					select:"",
					caption:"",
					placeholder:"",
					optDiv:"",
					...
					createElems:function(){
							...
							O.select=O.E.parent();O.caption=$("<span></span>");

...
<body>
	...
	<span id="commonMessageErrorId"  class="commonErrorMessage" style="margin-left: 37%!important;"></span>
...
<c:import url="${wordPressUrl}/sub-footer/" ></c:import>
 ...
 <script type="text/javascript" src="<%=request.getContextPath()%>/resource/api/chosen/chosen.jquery.js" ></script>
   <script type="text/javascript" src="<%=request.getContextPath()%>/resource/api/chosen/chosen.prism.js" charset="utf-8"></script>
</body>
</html>

          ...
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <a href="#landlordProfilePH" id="landlordProfilePH">My Profile</a>
                <div class="login-drop_1">
                  <ul>
                    <li><a href="#editLandlordPH" id="editLandlordPH">Edit Profile</a></li>
                    <li><a href="#changeLandlordPassword" id="changeLandlordPasswordPH">Change Password</a></li>
                  </ul>
                </div>
                </li>
                <li><a href="#myPropertyPH" id="myPropertyPH">My Properties</a></li>
                <li><a href="#registerPropertyPH" id="registerPropertyPH">Register New Property</a></li>
              </ul>
            </div>
          </div>
        </div>

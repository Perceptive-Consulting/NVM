...
<link type="text/css" rel="stylesheet" target="_blank" media="screen" href="<%=request.getContextPath()%>/resource/css/popup.css" />
...
<section class="contaner-b">
  <div class="container" id="containerId">
    <%@include file="/WEB-INF/jsp/user/propertyDeveloper/propertyDeveloperDetail.jsp" %>
  </div>
</section>
<div class="clearfix"></div>
